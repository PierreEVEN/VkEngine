...
void Rendering::Vulkan::GraphicPipeline::CreateGraphicPipeline()
{
	...
	ShaderModule vertShaderModule(vertShaderCode);
	ShaderModule fragShaderModule(fragShaderCode);
...
void Rendering::Vulkan::GraphicPipeline::DestroyGraphicPipeline()
{
