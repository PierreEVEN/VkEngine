...
public:
	...
	const String GetPropertyAsString(const char* categoryName, const char* propertyName, const char* defaultValue = "");
	...
	void SetPropertyAsString(const char* categoryName, const char* propertyName, const char* propertyValue) { SetProperty(categoryName, propertyName, propertyValue); }
