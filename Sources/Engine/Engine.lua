...
function includeShaderc()
	...
	filter "configurations:Release"
		...
		links(LibDir.."/Libs/Shaderc/Release/shaderc_spvc.lib")
		links(LibDir.."/Libs/Shaderc/Release/shaderc_util.lib")
		links(LibDir.."/Libs/Shaderc/Release/SPIRV.lib")
		links(LibDir.."/Libs/Shaderc/Release/spirv-cross-core.lib")
		links(LibDir.."/Libs/Shaderc/Release/spirv-cross-glsl.lib")
		links(LibDir.."/Libs/Shaderc/Release/spirv-cross-hlsl.lib")
		links(LibDir.."/Libs/Shaderc/Release/spirv-cross-msl.lib")
		links(LibDir.."/Libs/Shaderc/Release/spirv-cross-reflect.lib")
	...
	filter "configurations:Debug"
		...
		links(LibDir.."/Libs/Shaderc/Debug/shaderc_spvc.lib")
		links(LibDir.."/Libs/Shaderc/Debug/shaderc_util.lib")
		links(LibDir.."/Libs/Shaderc/Debug/SPIRVd.lib")
		links(LibDir.."/Libs/Shaderc/Debug/spirv-cross-cored.lib")
		links(LibDir.."/Libs/Shaderc/Debug/spirv-cross-glsld.lib")
		links(LibDir.."/Libs/Shaderc/Debug/spirv-cross-hlsld.lib")
		links(LibDir.."/Libs/Shaderc/Debug/spirv-cross-msld.lib")
		links(LibDir.."/Libs/Shaderc/Debug/spirv-cross-reflectd.lib")
